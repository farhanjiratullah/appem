...
@section('content')
    ...
    <div class="row">
        <div class="col-md-3">
            <a href="admin/akun-masyarakat" style="text-decoration: none; color: inherit;">
        ...
        <div class="col-md-3">
            <a href="admin/akun-petugas" style="text-decoration: none; color: inherit;">
                <div class="card mb-3 py-2" style="border-top-color: none; border-right-color: none; border-bottom-color: none; border-left-color: #0DCAF0; border-left-width: 3px;">
                    <div class="row g-0">
                        <div class="col-md">
                            <div class="card-body d-flex justify-content-between align-items-center">
        ...
        <div class="col-md-3">
            <a href="admin/pengaduan" style="text-decoration: none; color: inherit;">
        ...
        <div class="col-md-3">
            <a href="admin/pengaduan?keyword=proses" style="text-decoration: none; color: inherit;">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <a href="admin/pengaduan?keyword=selesai" style="text-decoration: none; color: inherit;">
                <div class="card mb-3 py-2" style="border-top-color: none; border-right-color: none; border-bottom-color: none; border-left-color: #198754; border-left-width: 3px;">
                    <div class="row g-0">
                        <div class="col-md">
                            <div class="card-body d-flex justify-content-between align-items-center">
